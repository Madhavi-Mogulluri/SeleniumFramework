...
public class AccountsPageSteps {
    ...
    private ProductResultsPage searchResultsPage;
    ...
    public void the_user_searches_for(String searchKey) {
        searchResultsPage = accPage.searchProduct(searchKey);
    }

    @Then("the result count should be {int}")
    public void the_result_count_should_be(int expectedCount) {
        Assert.assertEquals(expectedCount, searchResultsPage.productResultsCount());
    }
}